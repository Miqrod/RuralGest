-- Las crías nacidas muertas no tienen trayectoria productiva.
-- Asignarles tipo_productivo = 'Recría' distorsiona estadísticas y carece de significado.
-- Corrección: tipo_productivo_id = NULL para crías con estado_vital = 'muerto'.
-- La UI ya guarda {tipo_productivo_nombre && ...}, por lo que no aparecerá en la ficha.
...
BEGIN
  ...
  -- Tipo productivo solo para crías vivas
  ...
  -- Crías vivas: con tipo_productivo = 'Recría' y workflow de identificación activo
  FOR v_cria_id IN
  ...
  -- Crías muertas: sin tipo_productivo (NULL) — no tienen trayectoria productiva
  FOR v_cria_id IN
